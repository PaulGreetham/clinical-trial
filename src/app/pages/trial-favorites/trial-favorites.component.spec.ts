...
describe('TrialFavoritesComponent', () => {
  ...
  beforeEach(async () => {
    ...
    mockNotificationsService = jasmine.createSpyObj('NotificationsService', [
      ...
      'confirmRemoveMultipleFromFavorites',
    ]);

    mockNotificationsService.confirmRemoveFromFavorites.and.resolveTo({
      isConfirmed: true,
      isDenied: false,
      isDismissed: false,
    });
    mockNotificationsService.confirmRemoveMultipleFromFavorites.and.resolveTo({
      isConfirmed: true,
      isDenied: false,
      isDismissed: false,
    });
